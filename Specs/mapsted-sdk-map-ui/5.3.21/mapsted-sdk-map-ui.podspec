Pod::Spec.new do |s|  
    ...
    s.platform          = :ios
    s.source            = { :git => "https://github.com/Mapsted/mapsted-sdk-map-ui-simulator.git", :tag => '5.3.21' }
    ...
    s.libraries = "z", "c++"
    s.dependency 'mapsted-sdk-map', '5.3.21'
    s.dependency 'mapsted-sdk-loc-marketing', '5.3.21'
    s.dependency 'mapsted-sdk-alerts', '5.3.21'
    s.dependency 'mapsted-sdk-location-share','5.3.21'
end