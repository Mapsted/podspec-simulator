Pod::Spec.new do |s|  
    ...
    s.platform          = :ios
    s.source            = { :git => "https://github.com/Mapsted/mapsted-sdk-app-template-simulator.git", :tag => '6.0.2' }
    ...
    s.dependency 'mapsted-sdk-map-ui','6.0.2' 
    s.dependency 'mapsted-sdk-triggers-core','6.0.2' 
