Pod::Spec.new do |s|  
    ...
    s.platform          = :ios
    s.source            = { :git => "https://github.com/Mapsted/mapsted-sdk-app-template-simulator.git", :tag => '6.2.1' }
    s.ios.deployment_target = '13.0'
    s.ios.vendored_frameworks = "AppTemplate.framework"
    s.libraries = "z", "c++"
    s.dependency 'mapsted-sdk-loc-marketing', '6.2.1'
    s.dependency 'mapsted-sdk-alerts', '6.2.1'
