Pod::Spec.new do |s|  
    ...
    s.platform          = :ios
    s.source            = { :git => "https://github.com/Mapsted/mapsted-sdk-app-template-simulator.git", :tag => '6.2.7' }
    ...
    s.dependency 'mapsted-sdk-core','6.2.7'
    s.dependency 'mapsted-sdk-map', '6.2.7'
    s.dependency 'mapsted-sdk-location-share','6.2.7' 
    s.dependency 'mapsted-sdk-map-ui','6.2.7' 
    s.dependency 'mapsted-sdk-triggers-core','6.2.7'
